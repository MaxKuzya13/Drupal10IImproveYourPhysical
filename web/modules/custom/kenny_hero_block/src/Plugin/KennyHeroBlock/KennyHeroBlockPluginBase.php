...
/**
 * The base for all Kenny Hero Block plugins.
 */
abstract class KennyHeroBlockPluginBase extends PluginBase implements KennyHeroBlockPluginInterface, ContainerFactoryPluginInterface {
  /**
   * The current request
   *
