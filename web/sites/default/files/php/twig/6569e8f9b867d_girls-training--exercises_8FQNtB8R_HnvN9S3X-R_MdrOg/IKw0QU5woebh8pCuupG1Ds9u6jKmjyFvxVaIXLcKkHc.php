...
<div";
  ...
  <h2>";
        // line 20
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["term"] ?? null), "name", [], "any", false, false, true, 20), 20, $this->source), "html", null, true);
        echo "</h2>
  <div class=\"term-description\">";
        // line 21
        ((twig_get_attribute($this->env, $this->source, ($context["term"] ?? null), "description", [], "any", false, false, true, 21)) ? (print ($this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["term"] ?? null), "description", [], "any", false, false, true, 21), "value", [], "any", false, false, true, 21), "html", null, true))) : (print ("")));
        echo "</div>
  <div class=\"exercises-list\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 24
            echo "      ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["item"], 24, $this->source), "html", null, true);
            echo "
    ";
        }
    ...
    {
        return array (  75 => 26,  66 => 24,  62 => 23,  57 => 21,  53 => 20,  49 => 19,  46 => 18,  44 => 16,  43 => 15,  42 => 13,  39 => 12,);
    }
...
<div{{ attributes.addClass(classes) }}>
  <h2>{{ term.name }}</h2>
  <div class=\"term-description\">{{ term.description ? term.description.value }}</div>
  <div class=\"exercises-list\">
    {% for item in content %}
      {{ item }}
    {% endfor %}
    ...
    {
        static $tags = array("set" => 13, "for" => 23);
