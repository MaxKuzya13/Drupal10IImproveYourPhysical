...
($context["element"] ?? null)) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6["#bundle"] ?? null) : null), 45, $this->source)) . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["field_name"] ?? null), 45, $this->source))), 4 => ("field--type-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(        // line 46
...
{%
  set classes = [
    ...
    'field',
    element['#bundle']|clean_class ~ field_name|clean_class,
