...
($context["is_favourite"] ?? null)) ? ("remove-favorite") : ("add-favorite"))];
        // line 88
        echo "<article";
  ...
  ";
      ...
      <a href=\"";
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["title_class"] ?? null), 93, $this->source), "html", null, true);
            echo "__link\">";
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
      ...
      <div class=\"node__content-favorite\">
        ...
        echo "
          ...
          <button";
        // line 118
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["favorite_classes"] ?? null)], "method", false, false, true, 118), 118, $this->source), "html", null, true);
        echo " data-uid=\"";
        ...
        echo "\">
          ";
        // line 119
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(((($context["is_favorite"] ?? null)) ? ("Delete from favorite") : ("Add to favorite")));
        echo "
          </button>
    ...
    {
        return array (  172 => 119,  164 => 118,  159 => 116,  152 => 113,  148 => 112,  144 => 109,  135 => 104,  133 => 103,  129 => 102,  125 => 101,  121 => 99,  118 => 98,  114 => 97,  106 => 124,  104 => 112,  100 => 111,  97 => 110,  95 => 97,  90 => 96,  80 => 93,  73 => 92,  71 => 91,  67 => 90,  61 => 88,  59 => 85,  58 => 83,  55 => 82,  53 => 81,  50 => 80,  48 => 77,  47 => 76,  46 => 75,  45 => 74,  44 => 72,  41 => 70,);
    }
...
{% set favorite_classes = [
  'favorite-button',
  is_favourite ? 'remove-favorite' : 'add-favorite'
  ]
%}
    ...
    {% block content %}
      ...
      <div class=\"node__content-favorite\">
        {{ content.total_weight}}
          ...
          <button{{ attributes.addClass(favorite_classes) }} data-uid=\"{{ user_id }}\" data-nid=\"{{ node_id }}\">
          {{ is_favorite ? 'Delete from favorite' : \"Add to favorite\" }}
          </button>
