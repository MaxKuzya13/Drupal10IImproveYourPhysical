...
class __TwigTemplate_735da1544035ed0224b554d7e40ab0d1 extends Template
{
    private $source;
    private $macros = [];
      ...
      ";
          ...
          ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["update"]) {
                    ...
                    echo " (";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->env->getFilter('format_date')->getCallable()($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["update"], "timestamp", [], "any", false, false, true, 37), 37, $this->source), "html_date"), "html", null, true);
                    echo ")</li>
          ";
                }
...
", "core/modules/locale/templates/locale-translation-update-info.html.twig", "/var/www/html/web/core/modules/locale/templates/locale-translation-update-info.html.twig");
    }
