    ...
    public function block_content($context, array $blocks = [])
    {
      ...
      <div class=\"node__content-favorite\">
        ...
        echo "
          ...
          <button class=\"";
        // line 118
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["favorite_classes"] ?? null), 118, $this->source), "html", null, true);
        echo "\" data-uid=\"";
    ...
    {% block content %}
      ...
      <div class=\"node__content-favorite\">
        {{ content.total_weight}}
          ...
          <button class=\"{{ favorite_classes }}\" data-uid=\"{{ user_id }}\" data-nid=\"{{ node_id }}\">
