...
class __TwigTemplate_c28dd1d9a142735efa6be212564bb8de extends Template
{
    private $source;
    private $macros = [];
...
($context["paragraph"] ?? null), "bundle", [], "any", false, false, true, 44), 44, $this->source))) . \Drupal\Component\Utility\Html::getClass((((($context["view_mode"] ?? null) != "default")) ? (("-" . $this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 44, $this->source))) : ("")))), 2 => ((        // line 45
...
";
    ...
    {
        return new Source("", "themes/custom/kenny/templates/theme/paragraph.html.twig", "/var/www/html/web/themes/custom/kenny/templates/theme/paragraph.html.twig");
    }
